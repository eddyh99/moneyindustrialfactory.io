        ...
        <header class="header fixed-top">
            <div class="col-12 col-sm-12 form-group row" style="position:relative">
                <div class="d-flex justify-content-between align-items-center col-12 col-sm-12">
        			...
        			<span class="align-middle text-mif"><h1>Money Industrial Factory</h1></span>
        		...
        		<div class="col-2 col-sm-2 col-md-2" style="position:absolute;right:0;">
        		    ...
        		    <div class="col-12 col-sm-12 d-block d-sm-none">
                        <select  class="selectpicker" data-width="fit">
                            <option data-content='<span class="flag-icon flag-icon-us"></span>'  value="<?=base_url()?>languageSwitcher/switchlang/english" <?php echo ($_SESSION['site_lang'] == 'english') ? "selected" : "" ?>></option>
                            <option data-content='<span class="flag-icon flag-icon-it"></span>' value="<?=base_url()?>languageSwitcher/switchlang/italia" <?php echo ($_SESSION['site_lang'] == 'italia') ? "selected" : "" ?>></option>
                            ...
                            <option data-content='<span class="flag-icon flag-icon-fr"></span>' value="<?=base_url()?>languageSwitcher/switchlang/french" <?php echo ($_SESSION['site_lang'] == 'french') ? "selected" : "" ?>></option>
